...
public:
    ...
    **/
    ...
    /**
    Enables/disables strict mode for mime part.
    ...
    **/
    ...
    /**
    Returns strict mode status of mime part.
...
protected:
    ...
    **/
    void parse_content_type(const std::string& content_type_hdr, media_type_t& media_type, std::string& media_subtype,
    ...
    **/
    void parse_content_transfer_encoding(const std::string& transfer_encoding_hdr, content_transfer_encoding_t& encoding,
        std::map<std::string, std::string>& attributes);
    ...
    @throw *                `parse_header_value_attributes`.
    **/
    void parse_content_disposition(const std::string& content_disp_hdr, content_disposition_t& disposition,
        std::map<std::string, std::string>& attributes);
    ...
    **/
    void parse_header_value_attributes(const std::string& header, std::string& value, std::map<std::string, std::string>& attributes);
