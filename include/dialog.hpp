...
public:
    ...
    **/
    ...
    /**
    Receives a line from network without removing CRLF characters.
...
public:
    ...
    **/
    ...
    /**
    Receives encrypted or non-crypted line, depending of ssl state, without removing CRLF characters.
