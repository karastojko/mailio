...
/**
Base class for codecs for keeping line policy and various constants.
...
public:
    ...
    /**
    Calculates value of the given hex digit.
    **/
    ...
    **/
    ...
    Line length policy.
    **/
    enum class line_len_policy_t : std::string::size_type {NONE = 2048, RECOMMENDED = 78, MANDATORY = 998, HEADER = 62};

    /**
    Sets line policy of the codec.
