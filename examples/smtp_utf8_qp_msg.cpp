...
Connects to SMTP server and sends a message with UTF8 content.
...
int main()
{
    try
    {
        ...
        msg.add_recipient("mailio library", "mailio@outlook.com");// add more recipients
        msg.add_cc_recipient("mailio library", "mailio@yahoo.com");// add CC recipient
        msg.add_bcc_recipient("mailio library", "mailio@zoho.com");// add BCC recipient
