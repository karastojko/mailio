...
INCS_DIR = -I$(INC_DIR) -I$(BOOST_DIR)/include -I$(OPENSSL_DIR)/include
LIBS_DIR = -L$(BOOST_DIR)/lib -L$(OPENSSL_DIR)/lib
...
ifeq ($(OS), Darwin)
    TARGET = $(LIB_DIR)/lib$(PROJECT).dylib
else
