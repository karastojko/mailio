...
SOURCES = codec.cpp base64.cpp quoted_printable.cpp bit7.cpp bit8.cpp binary.cpp mailboxes.cpp mime.cpp message.cpp dialog.cpp smtp.cpp pop3.cpp imap.cpp
