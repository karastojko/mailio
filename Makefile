...
AR = ar
CXX = g++
CXX_FLAGS = -std=c++11 -Wall -Wno-unused-local-typedefs -Wno-unused-variable
...
SOURCES = codec.cpp base64.cpp quoted_printable.cpp bit7.cpp bit8.cpp mime.cpp message.cpp dialog.cpp smtp.cpp pop3.cpp imap.cpp
...
EXAMPLES_SOURCES = smtps_simple_msg.cpp pop3s_fetch_one.cpp imaps_stat.cpp
...
$(EXAMPLES_BINS):
	$(CXX) $(CXX_FLAGS) $(INCS_DIR) $(LIBS_DIR) -L$(LIB_DIR) $(LD_FLAGS) -l$(PROJECT) $(EXAMPLES_DIR)/$@.cpp -o $(EXAMPLES_DIR)/$@
