...
mime::mime() : _version("1.0"), _line_policy(codec::line_len_policy_t::RECOMMENDED), _strict_codec_mode(false),
    _content_type(media_type_t::NONE, ""), _encoding(content_transfer_encoding_t::NONE), _disposition(content_disposition_t::NONE),
    _parsing_header(true), _mime_status(mime_parsing_status_t::NONE)
{
}
