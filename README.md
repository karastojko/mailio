...
* version 0.10.0: Strict mode for message parser; expected timeframe is Q1/2017.
* version 0.11.0: Q codec to support non-ASCII message subjects; expected timeframe is Q1/2017.
* version 0.12.0: Clang and FreeBSD compatibility; expected timeframe is Q1/2017.

# Contact #

The library is still under development. In case you find a bug, please drop me a mail to mailio (at) alepho.com. Since this is my
